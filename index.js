...
/* can insert lines 15-17 && lines 29-31 here for simpler functionality*/
});
...
/* REMOVED const checkItem = $('ul').on('click', '.shopping-item-toggle', function(){
...
/* REMOVED const removeItem = $('ul').on('click', '.shopping-item-delete', function(){
    $(this).closest('li').remove();
});
*/
